...
const EditEmployee = () =>
{
   ...
   console.log(location.state.employee.employee_id);
    const[employee_id, setEmployeeid] = useState(location.state.employee.employee_id);
    const [employee_name , setName] = useState(location.state.employee.employee_name);
    ...
    const [employee_password , setPassword] = useState(location.state.employee.employee_password);
              ...
              <div class="col-lg-6 col-md-6 col-sm-12">
                  <div className='mt-5 pt-5'>
                    <form method="post" onSubmit={handleUpdateEmployee}>
                      ...
                      <input onChange={onEmployeeIdChange} value={employee_id} type="number" placeholder="Employee Id"  aria-label="First name" className="mt-2 form-control forgotpassword-input" />
                      <input onChange={onEmployeeNameChange} value={employee_name} type="text" placeholder="User Name"  aria-label="First name" className="mt-2 form-control forgotpassword-input" ></input>
                      ...
                      <input onChange={onEmployeePasswordChange} value={employee_password} type="password" placeholder="Password"  aria-label="First name" className="mt-2 form-control forgotpassword-input" ></input>
